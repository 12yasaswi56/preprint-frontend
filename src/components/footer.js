    ...
    <footer style={styles.footer}>
      <div style={styles.container}>
        <div style={styles.section}>
          ...
          <div style={styles.socialIcons}>
            <a href="https://www.linkedin.com/in/-harshitmittal/" 
               target="_blank" rel="noopener noreferrer" style={styles.icon} 
        ...
        <div style={styles.section}>
          ...
          <ul style={styles.list}>
            ...
            <li><Link to="/team" style={styles.link}>Team</Link></li>
          </ul>
        </div>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.contact}><i className="fas fa-map-marker-alt"></i> Pro H2Vis Solutions LLP, Hubli, Karnataka, India, Pincode: 580031 </p>
          <p style={styles.contact}><i className="fas fa-phone"></i> +91 8743944555 </p>
          <p style={styles.contact}><i className="fas fa-envelope"></i> <a href="mailto:info@enertransition.com" style={styles.link}>info@enertransition.com</a></p>
        </div>
      </div>
